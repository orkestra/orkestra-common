...
class DateTimeTypeTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        DateTime::setUserTimezone(new \DateTimeZone('Etc/GMT+6'));
    ...
    public function testConvertToDatabaseReturnsServerTime()
    {
        ...
        $datetime = DateTime::createFromFormat('Y-m-d H:i:s', '2011-01-01 12:00:00');
        
        // Force switch to local time
        $datetime->toUserTime();
        $this->assertEquals('2011-01-01 06:00:00', $datetime->format('Y-m-d H:i:s'));
        
        $this->assertEquals('2011-01-01 12:00:00', $this->_dateTimeType->convertToDatabaseValue($datetime, $this->_platform));
    }
